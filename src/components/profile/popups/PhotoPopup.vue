    ...
    <b-modal static @show="initModal" id="photo-modal" title="Profile image" hide-footer >
        ...
        <form id="photo-popup" @submit.prevent="crop" class="cms">
            ...
            <div class="btn-container">
                ...
                <button type="submit"  class="btn btn-primary btn-border btn-save" :disabled="account.status.uploadingImage">Save
                    <img v-show="account.status.uploadingImage" src="data:image/gif;base64," />
                </button>
            </div>
        </form>
    </b-modal>
