                    ...
                    <div class="radio-container">
                        ...
                        <div class="form-check radio">
                            ...
                            <div class="form-inline">
                                ...
                                <ValidationProvider rules="url" v-slot="{ errors }" >
                                    <input type="text" class="form-control item"  id="booking-payment-input" size="52%" v-model="data.bookingLink2"  :disabled="actionType !== 'BookingAndPayment'" placeholder="https://bookinglink.com" :class="{ 'is-invalid': submitted && errors.length }" style="margin-bottom: 5px;">
                                    <div v-if="submitted && errors.includes('url')" class="invalid-feedback">Link has wrong format, "https://" is required</div>
                                </ValidationProvider>

                                <label class="form-check-label item" for="payment-booking-input"></label>
                                <ValidationProvider rules="url" v-slot="{ errors }" >
                                    <input type="text" class="form-control item"  id="payment-booking-input" size="52%" v-model="data.paymentLink2"  :disabled="actionType !== 'BookingAndPayment'" placeholder="https://paymentlink.com" :class="{ 'is-invalid': submitted && errors.length }" >
                                    <div v-if="submitted && errors.includes('url')" class="invalid-feedback">Link has wrong format, "https://" is required</div>
                                </ValidationProvider>
            ...
            <form id="payment-booking-popup" class="cms">
                ...
                <div v-if="!invoice && !contact.status.messageSent">
                    ...
                    <div class="form-check" style="margin-bottom: 0.7rem">
                        <input class="form-check-input" type="radio" id="selectCalendar" :class="{ 'is-invalid': submitted && !proPlanActionType }"  v-model="proPlanActionType"  value="Booking" >
                    ...
                    <div class="form-check" style="margin-bottom: 0.7rem; display: flex; align-items: center">
                        <input class="form-check-input" type="radio" style="margin-bottom: 5px" id="selectPayments" :class="{ 'is-invalid': submitted && !proPlanActionType }"   v-model="proPlanActionType" value="Payment" >
                    ...
                    <div class="form-check" style="margin-bottom: 0">
                        <input class="form-check-input" :class="{ 'is-invalid': submitted && !proPlanActionType }" type="radio" id="selectCalendarAndPayments" v-model="proPlanActionType" value="BookingAndPayment" >
                        <label class="form-check-label" for="selectCalendarAndPayments">Both calendar and payments</label>
                    </div>
                    <div v-show="submitted && !proPlanActionType" style="display: block" class="invalid-feedback">Plan option is required</div>

                    <div style="margin-top: 2rem;" class="form-title">
                ...
                <div v-if="invoice && !contact.status.messageSent" class="form-group" style="margin-bottom: 4rem">
                    ...
                    <textarea class="form-control" :class="{ 'is-invalid': submitted && !invoiceData }" id="invoiceData" rows="6" v-model="invoiceData" placeholder="Here type your full name and address for invoicing purposes"></textarea>
                    <div v-show="submitted && !invoiceData" style="display: block" class="invalid-feedback">Plan option is required</div>
                </div>
                ...
                <div v-if="!contact.status.messageSent" class="row justify-content-center">
                    ...
                    <a href="#" id="choosePro" class="col-7 btn btn-primary btn-border" v-if="!invoice" v-on:click="goProPlan()">GO PRO PLAN</a>
    ...
    export default {
        ...
        methods: {
            ...
            initModal() {
                ...
                this.invoice = false;
                this.contact.status.messageSent = false;
                this.data = {
                ...
                this.$refs.form.validate().then(success => {
                    ...
                    if(this.actionType === 'BookingAndPayment') {
                        ...
                        if(this.actionType === 'None') {
                            this.updatePaymentBooking({});
                        } else if (this.actionType === 'Booking') {
                            console.log(this.bookingLink);
                            this.updatePaymentBooking({bookingLink: this.data.bookingLink, paymentLink: null});
                        }else if (this.actionType === 'Payment') {
                            console.log(this.paymentLink);
                            this.updatePaymentBooking({paymentLink: this.data.paymentLink, bookingLink: null});
                        }
            ...
            sendInvoice() {
                this.submitted = true;
                if(this.invoiceData) {
                    this.sendContactMessage({message: this.invoiceData + '     ' + this.proPlanActionType})
                }
            }
        }
    }
