...
<!-- PROFILE TEMPLATE -->
    ...
    <div id="background-rectangular" class="background-rectangular"></div>
    <div class="tu-container">
    <div class="row right-left-section-split">
...
<!-- LEFT SECTION -->
        ...
        <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12">
            <div class="left-section">
                ...
                <div class="short-bio">
                    <p class="short-bio-line-1">Hi, my name is {{response.profile.firstName}}.</p>
                    <p class="short-bio-line-2">I tutor {{formatArray(response.categories.map(cat => cat.categoryName))}}.</p>
...
<!-- ABOUT ME SECTION -->
        ...
        <div class="tu-card-container">
            <div id="section-about-me" class="tu-card">
                <div class="section-header"><h2>{{response.profile.headline}}</h2></div>
                    ...
                    <div class="row education-container">
                        ...
                        <div class="col-xl-8 col-lg-9 col-md-8 col-sm-12 col-12 education-items-list">
                            <div class="row education-items" v-for="school in response.schools" :key="school.value">
                                ...
                                <div class="col-10 education-item">
            ...
            <div id="section-subjects" class="tu-card">
                ...
                <div class="row subjects-container">
                    <div class="col-md-6 subject-cards" v-for="(category, index) in response.categories" :key="category.id">
                        <div class="subjects" :class="[index % 2 === 0 ? 'subject-border1' : 'subject-border2']">
...
<!-- RATES SECTION -->
            ...
            <div id="section-rates" class="tu-card">
                ...
                <div class="row rates-container">
                    <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 col-12 rates-items-all">

                        <div class="row rates-item" v-for="rate in response.rates" :key="rate.id">
                        ...
                        <div class="rate-additional-comment" v-if="response.profile.rateInfo.rateSectionComment">{{response.profile.rateInfo.rateSectionComment}}</div>
                        <div class="rate-section-comment" v-else>Details available upon request</div>
                ...
                <div class="terms-container">
                    <div class="terms-box">
                        ...
                        <div class="row terms-item">
                            <div class="col-1 terms-item-icon-container"><font-awesome-icon class="terms-item-icon" icon="globe" /></div>
                            <div class="col-11 terms-item-text">
                                <div class="terms-item-label">Online lessons:
                                    <div class="terms-item-value">
                                        <div v-if="response.profile.rateInfo.online" class="terms-item-value-input">Yes</div>
                                        <div v-else class="terms-item-value-input">None</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row terms-item">
                            <div class="col-1 terms-item-icon-container"><font-awesome-icon class="terms-item-icon" icon="home" /></div>
                            <div class="col-11 terms-item-text">
                                <div class="terms-item-label">In-person lessons:
                                    <div class="terms-item-value">
                                        <div v-if="response.profile.rateInfo.inPerson" class="terms-item-value-input">{{response.profile.rateInfo.inPersonComment === null ? 'Yes' : response.profile.rateInfo.inPersonComment}}</div>
                                        <div v-else class="terms-item-value-input">None</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row terms-item">
                            <div class="col-1 terms-item-icon-container"><font-awesome-icon class="terms-item-icon" icon="tag" /></div>
                            <div class="col-11 terms-item-text">
                                <div class="terms-item-label">Free consultation:
                                    <div class="terms-item-value">
                                        <div v-if="response.profile.rateInfo.freeConsultation" class="terms-item-value-input">{{response.profile.rateInfo.freeConsultationComment === null ? 'Yes' : response.profile.rateInfo.freeConsultationComment}}</div>
                                        <div v-else class="terms-item-value-input">None</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row terms-item">
                            <div class="col-1 terms-item-icon-container"><font-awesome-icon class="terms-item-icon" icon="calendar-alt" /></div>
                            <div class="col-11 terms-item-text">
                                <div class="terms-item-label">Cancelation policy:
                                    <div class="terms-item-value">
                                        <div v-if="response.profile.rateInfo.cancellationPolicy" class="terms-item-value-input">{{response.profile.rateInfo.cancellationPolicyComment === null ? 'Yes' : response.profile.rateInfo.cancellationPolicyComment}}</div>
                                        <div v-else class="terms-item-value-input">None</div>
                                    </div>
                                </div>
                            </div>
...
<!-- EXPERTISE SECTION -->
            ...
            <div id="section-expertise" class="tu-card" v-if="!(response.profile.youtubeIntroLink === null && response.problemCards.length === 0)">
                ...
                <div v-if="response.profile.youtubeIntroLink" class="youtube-input">
                ...
                <div class="expertise-arrows-container">
                    <div v-on:click="scroll('left')" class="carousel-left-arrow">
                    ...
                    <div id="problems" class="my-carousel" v-on:scroll.passive='handleScroll'>
                        <div class="carousel-container">
                            <div :id="'problem-card'+ index" class="problem-card" v-for="(problemCard, index) in response.problemCards" :key="problemCard.id">
                                <div class="carousel-icon"><img :src="getImgUrl(index)"></div>
