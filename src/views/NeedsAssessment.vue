        ...
        <div class="container assessment">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-8 offset-lg-1">
                    <h1>Which website builder is for me?</h1>
                    ...
                    <div v-else>
                        <h1 style="margin-top: 3rem">We sent quiz to your email</h1>
                        <h6 style="margin-top: 1rem; line-height: 1.4">You can also download it below</h6>
