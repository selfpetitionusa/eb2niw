<template>
    <div>
        ...
        <div style="top: 15px;z-index: 1;font-size: 16px" v-if="account.user.active === false" :class="`alert alert-danger`">Your account has been disabled. Please <a href="/help" style="text-decoration: underline; font-weight: 500">contact us</a> to activate it.</div>
