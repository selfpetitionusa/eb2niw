                        ...
                        <form @submit.prevent="handleSubmit" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <ValidationProvider rules="required" v-slot="{ errors }" >
                                    ...
                                    <div v-if="submitted && errors.length" class="invalid-feedback">Your expertise is required</div>
                                </ValidationProvider>
                            </div>
